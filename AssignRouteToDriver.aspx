<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AssignRouteToDriver.aspx.cs" Inherits="FleetTrack.AssignRouteToDriver" %>
    ...
    <div class="container">
        ...
        <table class="form">
             <tr>
                <td>Driver</td>
                <td>
                      <asp:DropDownList ID="ddlDriver" CssClass="textboxs" runat="server"></asp:DropDownList>
                    <asp:RequiredFieldValidator ID="rfvFullName" runat="server" ControlToValidate="ddlDriver" Display="Dynamic" 
                        ForeColor="Red" ErrorMessage="Please select driver" />
                </td>
