<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Route.aspx.cs" Inherits="FleetTrack.Route" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <div class="container">
        <h2>Route Registration Form</h2>
        <table class="form">
             <tr>
                <td>Route Name</td>
                <td>
                    <asp:TextBox ID="txtRouteName" CssClass="textboxs" runat="server"></asp:TextBox></td>
                    <asp:HiddenField ID="hdnCustomerId" runat="server" />
                <td>
                    <asp:RequiredFieldValidator ID="rfvFullName" runat="server"
                        ErrorMessage="Route Name is Required" ForeColor="Red" Display="Dynamic"
           ...
           <%-- <tr>
            ...
            <tr>
                <td>About Route</td>
                <td>
                    <asp:TextBox ID="txtAddress" CssClass="textareas" Rows="4" runat="server" TextMode="MultiLine"></asp:TextBox></td>
                <td>
                    <asp:RequiredFieldValidator ID="RfvPassword" runat="server"
                        ErrorMessage="Detail is Required" ForeColor="Red"
